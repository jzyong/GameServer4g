...
type ServerListRequest struct {
	...
	Type int32 `protobuf:"varint,2,opt,name=type,proto3" json:"type,omitempty"` //服务器类型
}
...
type ServerListResponse struct {
	...
	Server []*ServerInfo `protobuf:"bytes,2,rep,name=server,proto3" json:"server,omitempty"` // 服务器列表
}
...
type ServerInfo struct {
	...
	BelongID     int32  `protobuf:"varint,2,opt,name=belongID,proto3" json:"belongID,omitempty"`          // 归属服务器ID，即被合并到哪个服
	Ip           string `protobuf:"bytes,3,opt,name=ip,proto3" json:"ip,omitempty"`                       // 内网地址
	Type         int32  `protobuf:"varint,4,opt,name=type,proto3" json:"type,omitempty"`                  // 类型
	Port         int32  `protobuf:"varint,5,opt,name=port,proto3" json:"port,omitempty"`                  // 端口
	State        int32  `protobuf:"varint,6,opt,name=state,proto3" json:"state,omitempty"`                //// 状态 -1表示维护；0表示准备开启；1表示正常，2表示不显示，3表示内部开启
	Version      string `protobuf:"bytes,7,opt,name=version,proto3" json:"version,omitempty"`             // 版本号
	Content      string `protobuf:"bytes,8,opt,name=content,proto3" json:"content,omitempty"`             //服务器信息：
	Online       int32  `protobuf:"varint,11,opt,name=online,proto3" json:"online,omitempty"`             // 在线人数
	MaxUserCount int32  `protobuf:"varint,12,opt,name=maxUserCount,proto3" json:"maxUserCount,omitempty"` // 最大在线人数
	HttpPort     int32  `protobuf:"varint,13,opt,name=httpPort,proto3" json:"httpPort,omitempty"`         // http端口
	OpenTime     string `protobuf:"bytes,14,opt,name=openTime,proto3" json:"openTime,omitempty"`          //开服时间
	MaintainTime string `protobuf:"bytes,15,opt,name=maintainTime,proto3" json:"maintainTime,omitempty"`  //维护时间
	Name         string `protobuf:"bytes,16,opt,name=name,proto3" json:"name,omitempty"`                  //名字
	Wwwip        string `protobuf:"bytes,17,opt,name=wwwip,proto3" json:"wwwip,omitempty"`                // 外网地址
}
...
func (x *ServerInfo) GetBelongID() int32 {
	if x != nil {
		return x.BelongID
	}
	return 0
...
func (x *ServerInfo) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *ServerInfo) GetOnline() int32 {
	if x != nil {
		return x.Online
	}
	return 0
...
func (x *ServerInfo) GetMaxUserCount() int32 {
	if x != nil {
...
func (x *ServerInfo) GetHttpPort() int32 {
	if x != nil {
		return x.HttpPort
	}
	return 0
...
func (x *ServerInfo) GetOpenTime() string {
	if x != nil {
		return x.OpenTime
	}
	return ""
...
func (x *ServerInfo) GetMaintainTime() string {
	if x != nil {
...
func (x *ServerInfo) GetWwwip() string {
	if x != nil {
		return x.Wwwip
	}
	return ""
...
var file_server_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x50, 0x72,
	0x6f, 0x74, 0x6f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0xfc, 0x02,
	...
	0x62, 0x65, 0x6c, 0x6f, 0x6e, 0x67, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
	0x62, 0x65, 0x6c, 0x6f, 0x6e, 0x67, 0x49, 0x44, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x70, 0x18, 0x03,
	...
	,
